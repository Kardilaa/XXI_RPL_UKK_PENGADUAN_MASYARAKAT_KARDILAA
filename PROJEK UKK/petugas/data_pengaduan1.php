        ...
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                    <a href="datapengaduan1.php" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table"></i> <span class=" d-none d-sm-inline">Data Pengaduan</span></a>  
                           
                    </li>
                    <li>
                        <a href="from_tanggapan.php" class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-table"></i> <span class=" d-none d-sm-inline">Memberikan Tanggapan</span></a>
                    </li>
